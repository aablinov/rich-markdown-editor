...
import { DocumentIcon, CloseIcon, PlusIcon, TrashIcon, OpenIcon, } from "outline-icons";
...
class LinkEditor extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(Wrapper, null,
            React.createElement(Input, { value: value, placeholder: showCreateLink
            ...
            React.createElement(ToolbarButton, { onClick: this.handleOpenLink, disabled: !value },
                React.createElement(Tooltip, { tooltip: dictionary.openLink, placement: "top" },
                    React.createElement(OpenIcon, { color: theme.toolbarItem }))),
            React.createElement(ToolbarButton, { onClick: this.handleRemoveLink },
                React.createElement(Tooltip, { tooltip: dictionary.removeLink, placement: "top" }, this.initialValue ? (React.createElement(TrashIcon, { color: theme.toolbarItem })) : (React.createElement(CloseIcon, { color: theme.toolbarItem })))),
            showResults && (React.createElement(SearchResults, { id: "link-search-results" },
                results.map((result, index) => (React.createElement(LinkSearchResult, { key: result.url, title: result.title, subtitle: result.subtitle, icon: React.createElement(DocumentIcon, { color: theme.toolbarItem }), onMouseOver: () => this.handleFocusLink(index), onClick: this.handleSelectLink(result.url, result.title), selected: index === selectedIndex }))),
                showCreateLink && (React.createElement(LinkSearchResult, { key: "create", title: suggestedLinkTitle, subtitle: dictionary.createNewDoc, icon: React.createElement(PlusIcon, { color: theme.toolbarItem }), onMouseOver: () => this.handleFocusLink(results.length), onClick: () => {
