...
class BlockMenu extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(Portal, null,
            React.createElement(Wrapper, Object.assign({ id: "block-menu-container", active: isActive, ref: this.menuRef }, positioning),
                insertItem ? (React.createElement(LinkInputWrapper, null,
                    ...
                    items.map((item, index) => {
                        ...
                        return (React.createElement(ListItem, { key: index },
                            React.createElement(BlockMenuItem, { onClick: () => this.insertItem(item), selected: selected, icon: item.icon, title: item.title, shortcut: item.shortcut })));
                    }),
