...
This is special version of original rich-markdown-editor with some modifications for: wannadocs.com

1) Changed tsconfig.json to build as es6 module
2) Added Spoiler element


```bash
yarn add @andreyblinov/rich-markdown-editor
```
